...
class Rotary:
    ...
    def _pulse(self, gpio, level, tick):
        ...
        Decode the rotary encoder pulse.
            ...
            ----+         +---------+         +---------+  1
        """
        print(f"entry. gpio={gpio}, level={level}, levA={self.levA}, levB={self.levB}")
        if gpio == self.gpioA:
            self.levA = level
        else:
            self.levB = level
        ...
        if gpio != self.lastGpio:  # debounce
            ...
            if gpio == self.gpioA and level == 1:
                if self.levB == 1:
                    ...
                    print(
                        f"noop. gpio={gpio}, level={level}, levA={self.levA}, levB={self.levB}"
                    )
    ...
    def __init__(self, gpioA=None, gpioB=None, gpioSW=None, callback=None):
...
def main():
    ...
    decoder = Rotary(gpioA=17, gpioB=27, gpioSW=4, callback=callback)
    ...
    # def down_callback(c):
    #     print("Down rotation", c)

    # my_rotary = Rotary(gpioA=17, gpioB=27, gpioSW=4)
